...
def backward(input, activations, scale=True, alpha=1.0):
    ...
    # KL update gradient
    if scale:
        dWv += dKL_dWv/ batch_size
        dWi += dKL_dWi/ batch_size
        dWm += dKL_dWm/ batch_size
        dBv += dKL_dBv/ batch_size
        dBm += dKL_dBm/ batch_size
        dBi += dKL_dBi/ batch_size
    else:
        dWv += dKL_dWv
        dWi += dKL_dWi
        dWm += dKL_dWm
